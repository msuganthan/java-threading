package org.suganthan.deferredCallback;
...
class DeferredCallbackExecutor {
    ...
    PriorityQueue<Callback> callbackPriorityQueue = new PriorityQueue<Callback>(new Comparator<Callback>() {
        @Override
    ...
    /**
     * Execution thread workflow:
     * 1. Initially the queue will be empty and the execution thread should just wait indefinitely on the condition variable
     * to be signaled.
     * 2. W
